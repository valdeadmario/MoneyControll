...
/***/ "./src/js/views/moneyView.js":
/*!***********************************!*\
  !*** ./src/js/views/moneyView.js ***!
  \***********************************/
/*! exports provided: getInput, addNewItemToList, deleteItemFromUI, clearFields, displayBudget, displayPercentages, displayMonth, changeType, formatNumber, reloadPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getInput\", function() { return getInput; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"addNewItemToList\", function() { return addNewItemToList; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"deleteItemFromUI\", function() { return deleteItemFromUI; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"clearFields\", function() { return clearFields; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"displayBudget\", function() { return displayBudget; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"displayPercentages\", function() { return displayPercentages; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"displayMonth\", function() { return displayMonth; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"changeType\", function() { return changeType; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"formatNumber\", function() { return formatNumber; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"reloadPage\", function() { return reloadPage; });\n/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\r\n\r\nconst getInput = () => {\r\n    return {\r\n        type: document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].type).value,\r\n        description: document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].description).value,\r\n        value: parseFloat(document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].value).value)\r\n    }\r\n}\r\n\r\nconst addNewItemToList = (newItem, type) => {\r\n    let container;\r\n    let itemList = `<li class=\"item\" id=\"${type}-${newItem.id}\">\r\n                                <p class=\"item__description\">${newItem.description}</p>\r\n                                <div class=\"wrap\">\r\n                                     <div class=\"wrapper\">\r\n                                         <span class=\"item__value\">${undefined.formatNumber(type, newItem.value)}</span>\r\n                                         ${type === 'exp' ? `<span class=\"item__percentage\">${type}</span>` : ''}\r\n                                     </div>\r\n                                     <div class=\"item__delete\">\r\n                                         <button class=\"item__delete--btn\"><i class=\"fas fa-trash-alt\" style=\"font-size:20px;color:gray\"></i></button>\r\n                                     </div>\r\n                                </div>\r\n                            </li>`\r\n    if (type === 'exp') {\r\n        container = _base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].expensesList;\r\n    }else {\r\n        container = _base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].incomeList;\r\n    }\r\n    document.querySelector(container).insertAdjacentHTML('beforeend', itemList)\r\n}\r\n\r\nconst deleteItemFromUI = (selectorID) => {\r\n    document.getElementById(selectorID).remove();\r\n}\r\n\r\nconst clearFields =  () => {\r\n    document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].description).value = '';\r\n    document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].value).value = '';\r\n}\r\n\r\nconst displayBudget = (budget, inc, exp, percentage) => {\r\n    let type;\r\n\r\n    (budget > 0) ? type = 'inc' : type = 'exp'\r\n\r\n    document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].budget).innerHTML = undefined.formatNumber(type, budget);\r\n    document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].incomeBudget).innerHTML = undefined.formatNumber('inc', inc);\r\n    document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].expenseBudget).innerHTML = undefined.formatNumber('exp', exp);\r\n    if (percentage > 0) {\r\n        document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].percentageBudget).innerHTML = `${percentage}%`;\r\n    }else {\r\n        document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].percentageBudget).innerHTML = '...';\r\n    }\r\n}\r\n\r\nconst displayPercentages = percentages => {\r\n\r\n    const itemList = Array.from(document.querySelectorAll(_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].percentageItem));\r\n    itemList.forEach( (item, index) => {\r\n        if (percentages[index] > 0){\r\n            item.textContent = `${percentages[index]}%`;\r\n        }else {\r\n            item.textContent = '...';\r\n        }\r\n    })\r\n}\r\n\r\nconst displayMonth = () => {\r\n    let year, month, num;\r\n    const months = ['January','February','March','April','May','June','July','August','September','October','November','December']\r\n\r\n    const dateNow = new Date();\r\n\r\n    year = dateNow.getFullYear();\r\n    month = months[dateNow.getMonth()];\r\n    num = dateNow.getDate();\r\n\r\n\r\n    document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].date).textContent = `${num} ${month} ${year}`;\r\n\r\n}\r\n\r\nconst changeType = () => {\r\n    // get all input fields in array\r\n    const allFields = Array.from(document.querySelectorAll(`${_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].type},${_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].value},${_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].description}`));\r\n\r\n    allFields.forEach( (item) => {\r\n        item.classList.toggle('red-focus')\r\n    })\r\n\r\n}\r\n\r\nconst formatNumber = (type, number) => {\r\n    let intPart, decimalPart;\r\n    number = Math.abs(number).toFixed(2);\r\n    intPart = number.split('.')[0]\r\n    decimalPart = number.split('.')[1]\r\n\r\n\r\n    if (intPart.length > 3) {\r\n        number = `${intPart.substring(0,intPart.length -3)},${intPart.substring(intPart.length -3)}.${decimalPart}`\r\n    }\r\n    return `${type === 'exp' ? '-' : '+'} ${number}`\r\n}\r\n\r\nconst reloadPage = items => {\r\n    items.inc.forEach( (item) => {\r\n        undefined.addNewItemToList(item, 'inc')\r\n    })\r\n    items.exp.forEach( (item) => {\r\n        undefined.addNewItemToList(item, 'exp')\r\n    })\r\n}\n\n//# sourceURL=webpack:///./src/js/views/moneyView.js?");
